...
import com.talkjs.talkjs_flutter_inappwebview.types.JsPromptResponse;
...
public class InAppWebViewChromeClient extends WebChromeClient implements PluginRegistry.ActivityResultListener, ActivityResultListener {
  ...
  public InAppWebViewChromeClient(@NonNull final TalkJSInAppWebViewFlutterPlugin plugin,
  ...
  public boolean onActivityResult(int requestCode, int resultCode, Intent data) {
    if (TalkJSInAppWebViewFlutterPlugin.filePathCallback == null && TalkJSInAppWebViewFlutterPlugin.filePathCallbackLegacy == null) {
      return true;
    }
    ...
    switch (requestCode) {
      case PICKER:
        ...
        if (TalkJSInAppWebViewFlutterPlugin.filePathCallback != null) {
          TalkJSInAppWebViewFlutterPlugin.filePathCallback.onReceiveValue(results);
        }
        break;
      ...
      case PICKER_LEGACY:
        ...
        TalkJSInAppWebViewFlutterPlugin.filePathCallbackLegacy.onReceiveValue(result);
        break;
    }

    TalkJSInAppWebViewFlutterPlugin.filePathCallback = null;
    TalkJSInAppWebViewFlutterPlugin.filePathCallbackLegacy = null;
  ...
  public void startPickerIntent(ValueCallback<Uri> filePathCallback, String acceptType, @Nullable String capture) {
    TalkJSInAppWebViewFlutterPlugin.filePathCallbackLegacy = filePathCallback;
  ...
  public boolean startPickerIntent(final ValueCallback<Uri[]> callback, final String[] acceptTypes,
    ...
    TalkJSInAppWebViewFlutterPlugin.filePathCallback = callback;
